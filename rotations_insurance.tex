...
The same scoring exercise applied to the soybean sample (Figure~\ref{fig:soy_score_yield}) shows a qualitatively similar but much smaller-scale pattern, with scores ranging from roughly $-0.46$ to $+1.29$ relative to soybean monoculture (score $=0$) and a broadly positive, though not strictly monotone, relationship with mean soybean yield.
