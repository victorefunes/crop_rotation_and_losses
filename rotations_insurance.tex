...
\begin{table}[H]
  ...
  \begin{threeparttable}
    ...
    \begin{minipage}{\textwidth}
      \small
      Notes: Dependent variable is QDANN soybean yield in bushels per
...
\begin{table}[H]
  ...
  \begin{threeparttable}
    ...
    \begin{minipage}{\textwidth}
      \small
      Notes: Dependent variable is corn yield in bushels per acre.
...
\begin{table}[H]
  ...
  \begin{threeparttable}
    ...
    \begin{minipage}{\textwidth}
      \small
      Notes: RCI entered as a factor variable; reference category is
...
\begin{table}[H]
  ...
  \begin{threeparttable}
    ...
    \begin{minipage}{\textwidth}
      \small
      Notes: See Table~\ref{tab:corn_rci} notes. Dependent variable is
...
\begin{table}[H]
  ...
  \begin{threeparttable}
    ...
    \begin{minipage}{\textwidth}
      \small
      Notes: Column (1) reports stage-1 mean coefficients; column (2)
