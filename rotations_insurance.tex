...
% TODO: the "2.59" figure here is the same unverified carryover flagged in detail at
% Section~\ref{subsec:rot_score_res} -- it appears verbatim in an earlier presentation
% that used different (larger, one sign-flipped) Z-vector coefficients, and an attempt to
% independently reproduce it by hand failed. Update this sentence once the score has been
% regenerated from the current Table~\ref{tab:zvector} coefficients.
