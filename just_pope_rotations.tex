...
This paper uses a large satellite-based field-level panel of Illinois corn yields from 2008 to 2022, with rotation histories built from Cropland Data Layer records back to 2002, to estimate how six-year crop rotation sequences affect both the mean and variance of corn yields. Our main findings are four.
