...
% RESOLVED: corn sample sizes now reconcile into two figures:
%   - 1,796,806 -- qualifying QDANN sample before the missing-VPD filter.
%   - 1,785,861 -- common estimation sample for ALL field-level corn tables in the current
%     re-run: corn_rot, corn_rci, corn_jp_moments, corn_jp_var, corn_jp_skew, corn_zvector
%     (folded into zvector.tex), corn_rot_vpd, corn_rci_vpd, corn_rci_jp. The 10,945-obs
%     difference is exactly the field-years dropped for missing vapor pressure deficit.
%   - 1,799,074 -- unrestricted candidate pool, corn_lasso only.
...
% signal. RESOLVED: tables/zvector.tex is the three-feature model (late_soy 0.447,
% soy_gap 0.693, soy_cons 1.210; variance soy_gap -3.75, p<0.10), N = 1,785,861,
% field + year FE, clustered at county + year. The redundant tables/corn_zvector.tex
% was removed. Regenerated by code/corn_analysis_full.R (corn_z_s1 / corn_z_s2).
