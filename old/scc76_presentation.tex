...
\begin{frame}{Rotation Complexity Index}
    \begin{wideitemize}
        ...
        \item We use average farm area-weighted RCI values per county/year throughout our analysis.
    \end{wideitemize}
\end{frame}
...
%    \include{tables/cs_fit_full}
%\end{frame}

%\begin{frame}{Cover Crop adoption (growing period)}
%    \include{tables/cs_fit_full_rp}
%\end{frame}
...
%    \include{tables/rci_fit_int}
%\end{frame}

\begin{frame}{RCI (post-emergence)}
    \include{tables/rci_fit_int_rp}
\end{frame}

\begin{frame}{RCI Coefficient plot (post-emergence)}
    \begin{figure}[H]
    \centering
    \includegraphics[scale = 0.5]{figures/coef_plot_rp.png}
...
\begin{frame}{RCI Coefficient plot (preventive planting)}
    \begin{figure}[H]
    \centering
    \includegraphics[scale = 0.5]{figures/coef_plot_pp.png}
    \caption{Effect of RCI on loss ratios}
...
\begin{frame}{Acknowledgements}
    \centering
    \begin{wideitemize}
        \item Department of Statistics, Rice University
        \item Department of Statistics and Probability, Michigan State University
        \item Tim Bowles and Agroecology Lab, University of California, Berkeley
        \item Land Core Inc.
        \item FFAR and USDA-AFRI
    \end{wideitemize}
\end{frame}
